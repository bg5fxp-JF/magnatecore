export const servicesData = [
	...
	},
	{
		...
		desc: "Jack of all trades, master of none. Specialization is key. That's why we focus solely on YOUR industry, ensuring we can guarantee results.",
		icon: "robot",
	},
	{
		link: "",
		name: "LOCAL IS FOCAL",
		desc: "We're not an anonymous entity, hidden away in some office. As a local company, we're accessible whenever you need us.",
		icon: "strategy",
	},
];
